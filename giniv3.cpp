...
{
	int index = 0;
	string alldata[30] = {"Name", "a", "b", "c", "d", "Recommend", "1", "0", "1", "1", "Reservation", "no", "no", "yes", "yes", "Price Range", "above 5k", "below 5k", "below 5k", "below 5k", "Cuisine", "American", "American", "Desi", "American", "Timing", "Lunch", "Breakfast", "Breakfast,Lunch", "Breakfast,Lunch,Dinner"};
